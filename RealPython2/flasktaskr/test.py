...
class AllTests(unittest.TestCase):
    ...
    def setUp(self):
        '''
        The setUp() method was invoked which created a test database (if it did not
...
#        '''
#        The test_user_setup() method was called, inserting data into the "users" table.
#        '''
...
#==============================================================================
    def test_users_can_register(self): # integration test
        '''
        We're testing whether a new user is successfully added to the database.
        ...
        Getting Started which is "michael".
        '''
        new_user = User("michael", "michael@mherman.org", "michaelherman")
        db.session.add(new_user)
        db.session.commit()
